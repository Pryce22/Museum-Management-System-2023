...
class Ui_VistaHomeDirettore(object):
    ...
    def retranslateUi(self, VistaHomeDirettore):
        ...
        VistaHomeDirettore.setWindowTitle(_translate("VistaHomeDirettore", "Home direttore"))
        ...
        self.pushButton_5.setText(_translate("VistaHomeDirettore", "Elimina dipendente"))
