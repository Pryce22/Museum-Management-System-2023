from test.test_beni.ListaBeniTest import *
import pickle
import os
import sys
...
class ControlloreListaBeni:
    def __init__(self):
        ...
        if os.path.isfile("lista_beni_salvata_test.pickle") and os.path.getsize('lista_beni_salvata_test.pickle') > 0:
            with open('lista_beni_salvata_test.pickle', 'rb') as f:
